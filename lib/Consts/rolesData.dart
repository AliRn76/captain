...
List<RolesModel> rolesList = [
  ...
  RolesModel(
    ...
    isSelected: false.obs,
    description:
        'روانی رتبه هفتم تیم مافیا، شخصیت مقابل روانشناس است (این نقش فقط با وجود روانشناس باید در بازی باشد) مافیا روانی باید در فاز شب شخصی را انتخاب کند که اگر آن فرد در فاز شب شاهد قتل روانشناس باشد و در صورت تأیید خود آن شخص تیر بخورد (طراحی شده توسط: محمدرضا سلطانی)',
    options: [
